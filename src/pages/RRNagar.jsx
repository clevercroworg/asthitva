...
function RRNagar() {
  ...
  const venuesData = [
    {
      ...
      capacity: '150 - 250 Seating | 700 Floating',
    ...
    },
    {
      ...
      capacity: '150 - 250 Seating | 700 Floating',
      image: '/images/rr-nagar/venue-2/video-thumbnail.webp', 
  ...
  return (
    <div className="app">
      <Navbar logoText="RR Nagar" topBarText="Premium event venue at RR Nagar" phone="+91 95354 15379" />
